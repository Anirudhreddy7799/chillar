...
// Process environment with fallbacks for running outside of Replit
export const env = {
  // Database
  DATABASE_URL: process.env.DATABASE_URL || 'postgres://postgres:postgres@localhost:5432/chillar_club',
  ...
  USE_FIREBASE_AS_PRIMARY: process.env.USE_FIREBASE_AS_PRIMARY === 'true' || true,
  ...
  useDevPayments: () => process.env.NODE_ENV !== 'production' || 
