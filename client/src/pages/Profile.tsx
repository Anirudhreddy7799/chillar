                  ...
                  <Button
                    ...
                    onClick={() => {
                      navigator.clipboard.writeText(
                        `https://chillarclub.in/join?ref=${currentUser?.referralCode || ""}`
                      );
                      toast({
                        title: "Copied!",
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="py-2 px-3 border rounded-md bg-muted">
                          {profileData.uniqueId || "Not assigned"}
                        </div>
                      </div>
                        ...
                        <DialogContent className="sm:max-w-[425px]">
                          ...
                          <div className="py-4">
                            <p className="text-sm text-destructive">
                              Warning: If you have an active subscription, it
                              will be cancelled immediately without refund.
                            </p>
                          </div>
                          <DialogFooter>
                            <Button
