...
const settingsFormSchema = z.object({
  ...
  drawDayOfWeek: z.string().min(1, "Draw day is required"),
  drawHour: z.string().min(1, "Draw time is required"),
...
export const DrawSettingsSection = ({
  form: parentForm,
  standalone = false,
    ...
    try {
      const drawSettingsResponse = await apiRequest(
        ...
        "/api/settings/draw",
        {
          ...
          drawDayOfWeek: parseInt(data.drawDayOfWeek),
          drawHour: parseInt(data.drawHour),
